...
<form method="post" action="<?php echo U('admin/login/login') ?>" onsubmit="return validate()">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <img onclick="this.src='<?php echo U('admin/login/code')?>#'+Math.random();" style="cursor:pointer " src="<?php echo U('admin/login/code')?>"   alt="">
                        </td>
                    </tr>
