    ...
    <form name="main_form" method="POST" action="/index.php/Admin/Admin/edit/id/7.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td >
                    <?php foreach($rodata as $k=>$v): if(in_array($v['id'],$rid)) $checked="checked='checked'"; else $checked=''; ?>
                    <?php echo $v['role_name'] ?> <input  type="checkbox"  name="rid[]" <?php echo $checked; ?> value="<?php echo $v['id'] ?>">
                    <?php endforeach;?>
                </td>
