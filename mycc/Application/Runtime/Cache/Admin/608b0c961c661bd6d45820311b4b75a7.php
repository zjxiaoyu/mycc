                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="cat_id" id="">
                            ...
                            <?php foreach($cat_id as $k=>$v) { if($info['cat_id']==$v['id']) { $select="selected='selected'"; }else { $select=''; } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="ext_cat_id[]" >
                            <option value="">请选择分类</option>
                            <?php foreach($cat_id as $k=>$v) { if($vv['cat_id']==$v['id']) $select2="selected='selected'"; else $select2=''; ?>
                ...
                <tr>
                    ...
                    <td>
                        <select name="type_id" id="" >
                            ...
                            <?php
 foreach($typedata as $k=>$v) : if($info['type_id']==$v['id']) $select="selected='selected'"; else $select =''; ?>
                            ...
                            <li>
                               <a href="javascript:void(0);" onclick="addNewli(this) ">[+]</a>
                                ...
                                <option value="" >请选择属性</option>;
                                 <?php
 $type_value=explode(',',$v['attr_type_value']); foreach($type_value as $kk=>$vv): if($v['attr_value']==$vv) $select= 'selected=selected'; else $select=''; ?>
